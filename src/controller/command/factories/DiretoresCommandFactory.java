...
import controller.command.impl.diretor.AdicionarFilme;
import controller.command.impl.diretor.ExcluirDiretor;
import controller.command.impl.diretor.ListarTodosDiretores;
import controller.command.impl.diretor.NovoDiretor;
import controller.command.impl.diretor.PesquisarPorNome;
import controller.command.impl.diretor.RemoveFilme;
import controller.command.impl.diretor.Renomear;
